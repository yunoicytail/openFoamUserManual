...
$$
\underbrace{\frac{\partial \alpha_k \rho_kh_k}{\partial t}} \text{fvm::ddt(alpha1, rho1, he1)}+\underbrace{\nabla \cdot (\alpha_k \rho_k\boldsymbol{u}_k h_k)}\text{fvm::div(alphaRhoPhi1, he1)}-\underbrace{h_k(\frac{\partial \alpha_k \rho_k}{\partial t}+\nabla \cdot (\alpha_k \rho_k\boldsymbol{u}_k))}\text{contErr1} = RHS
$$
